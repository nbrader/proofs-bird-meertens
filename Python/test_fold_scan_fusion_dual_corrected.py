...
def test_corrected_fold_scan_fusion_pair_dual(xs):
    """Test the fold_scan_fusion_pair_dual lemma with CORRECTED scan_left"""
...
def run_tests():
    ...
    for xs, desc in test_cases:
        lhs, rhs, scan_result = test_corrected_fold_scan_fusion_pair_dual(xs)
